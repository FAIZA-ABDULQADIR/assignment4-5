...
const Navbar: React.FC = () => {
    ...
    return (
        <div className="flex">
                        ...
                        <ul className="flex flex-col space-y-4">
                            ...
                            <li className="group relative z-30 w-full">
                                ...
                                <ul className="dropdown-content hidden group-hover:flex flex-col bg-[#023e8a] text-[#f0f0f0] border border-[#ff7043] rounded-lg shadow-lg overflow-auto p-4 space-y-2 absolute left-0 top-full">
                                    ...
                                    <li><Link href='/blog_2' className="text-[#00b4d8] font-semibold transform hover:underline hover:scale-105  hover:text-[#ffbd00] transition-all duration-300 px-2 py-1 rounded">10 Effective Ways to Manage Your Child&apos;s Screen Time</Link></li>
                                    ...
                                    <li><Link href='/blog_4' className="text-[#00b4d8] font-semibold transform hover:underline hover:scale-105  hover:text-[#ffbd00] transition-all duration-300 px-2 py-1 rounded">Fostering Independence in Children</Link></li>
                                    <li><Link href='/blog_5' className="text-[#00b4d8] font-semibold transform hover:underline hover:scale-105  hover:text-[#ffbd00] transition-all duration-300 px-2 py-1 rounded">Nutrition for Kids</Link></li>
                                    <li><Link href='/blog_6' className="text-[#00b4d8] font-semibold transform hover:underline hover:scale-105  hover:text-[#ffbd00] transition-all duration-300 px-2 py-1 rounded">Self-Care for Parents</Link></li>
                                </ul>
                            </li>
            ...
            <nav className="w-full justify-between items-center p-4 text-[#f0f0f0] bg-[#ffb703] md:flex md:justify-between md:items-center md:h-20 hidden z-50">
                <div className="logo text-3xl font-black font-family:Arial text-[#78290f]">
                    <h2><Link href="/">myBlogs</Link></h2>
                </div>
                ...
                <div className="nav-links">
                    <ul className="flex space-x-6">
                        ...
                        <li>
                            <Link href="/contact" className="text-2xl text-[#023047] link hover:bg-[#ee4266] hover:text-white transform hover:scale-105 transition-all duration-300 px-2 py-1 rounded">
                                Contact Us
                            </Link>
                        </li>
                    </ul>
